        ...
        <div class="row">
            <div class="col-12 col-md-6 col-xl-4">
                <button class="btn btn-dark d-md-none border w-100 mb-2" type="button" data-bs-toggle="offcanvas"
                    data-bs-target="#offcanvasMatListResponsive">
                    OPEN LIST
                </button>
                <div class="offcanvas-md offcanvas-start" tabindex="-1" id="offcanvasMatListResponsive"
                    ...
                    <div class="offcanvas-header">
                        ...
                        <button type="button" class="btn-close" data-bs-dismiss="offcanvas"
                            data-bs-target="#offcanvasMatListResponsive"></button>
                    </div>
                    ...
                    <div class="offcanvas-body">
                        ...
                        <div class="row w-100">
                            <div class="col-12 col-lg-4">
                                <button class="btn btn-dark d-lg-none border w-100 mb-2" type="button"
                                        ...
                                        <div class="row">
                                            <div class="input-group">
                                                <input type="text" class="form-control" list="datalistOptions"
                                                    v-model="typeID" placeholder="Type" />
